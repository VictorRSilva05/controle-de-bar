...
public class RepositorioContaSQL : IRepositorioConta
{
    ...
    public void AdicionarPedido(Conta conta, Pedido pedido)
    {
        ...
        comandoAdicao.Parameters.AddWithValue("QUANTIDADESOLICITADA", pedido.Quantidade);
    ...
    private void AdicionarPedidos(Conta conta)
    {
        ...
        foreach (Pedido p in conta.Pedidos)
        {
            ...
            comandoAdicao.Parameters.AddWithValue("QUANTIDADESOLICITADA", p.Quantidade);
    ...
    private Pedido ConverterParaPedido(SqlDataReader leitor)
    {
        ...
        return new Pedido()
        {
            Id = Guid.Parse(leitor["ID"].ToString()!),
            Produto = produto,
            Quantidade = Convert.ToInt32(leitor["QUANTIDADESOLICITADA"])
        };
    }
